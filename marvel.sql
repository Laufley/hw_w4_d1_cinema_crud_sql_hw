...
SELECT name = 'Homer Simpson' FROM people; ---> why is this one not working?
...
INSERT into movies (title, year, show_time) VALUES ('Avengers: Infinity War', 2014, '22:15');
SELECT * FROM movies;
...
--  18 | Thor: Ragnarok                      | 2017 | 22:10
--  19 | Black Panther                       | 2018 | 21:00
--  20 | Avengers: Infinity War              | 2014 | 22:15
-- (20 rows)
...
-- 1. With a range:
DELETE FROM movies WHERE title BETWEEN 'Batman Begins' AND 'Captain America: The Winter Soldier';
SELECT * FROM movies;
-- id |           title           | year | show_time 
-- ----+---------------------------+------+-----------
--   1 | Iron Man                  | 2008 | 17:00
...
--  19 | Black Panther                       | 2018 | 21:00
-- (15 rows)
-- 3. Delete everything from the table:
DELETE FROM movies;
SELECT * FROM movies;
--  id | title | year | show_time 
-- ----+-------+------+-----------
